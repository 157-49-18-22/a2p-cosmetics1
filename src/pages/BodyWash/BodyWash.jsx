      ...
      <div className="lips-container">
          ...
          <div className="filters-card">
            ...
            <div className="filter-section expanded">
              ...
              <div className="size-grid">
                {['Vit C', 'Aloe', 'Tea Tree', 'Niacinam.', 'Peptide', 'Squalane'].map(ing => (
        ...
        <main className="products-content">
          <div className="products-header">
            <span className="products-count">{filteredProducts.length} Refreshing Body Washes Found</span>
          </div>
              ...
              filteredProducts.map(product => (
                <div key={product.id} className="lip-card">
                  <div className="lip-card-img">
                    ...
                    <img src={product.image_url || "/body_wash_product.png"} alt={product.name} className="primary-img" />
