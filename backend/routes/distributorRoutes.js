...
// Portal Specific
router.get('/:id/inventory', distributorController.getDistributorInventory);
router.get('/:id/stats', distributorController.getDistributorStats);
router.get('/:id/dealers', distributorController.getDealers);
router.get('/:id/dealer-orders', distributorController.getDealerOrders);
router.patch('/dealer-orders/:orderId/status', distributorController.updateDealerOrderStatus);
...
router.get('/campaigns/for-dealer/:dealerId', distributorController.getCampaignsForDealer);
...
router.put('/zones/:id', distributorController.updateZone);
...
router.put('/bills/:id', distributorController.updateInvoice);
router.delete('/bills/:id', distributorController.deleteInvoice);
